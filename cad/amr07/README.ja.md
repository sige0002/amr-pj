...
> **現行案は[D6.5：1階電装・2階荷台](two-story/README.ja.md)。BOMは[Markdown概要](two-story/BOM.ja.md)／[全明細Markdown](two-story/BOM-details.ja.md)／[CSV](two-story/BOM.csv)を参照。** 車体10kgは目安へ変更し、現行の荷重計算は車体10.5kgまでを比較範囲とする。以下は旧構成の履歴。
