...
| 重量 | **推計8.748kg**、10kgまで約1.252kg。購入部品の実測値ではない |
...
| 費用全体 | 途中小計**54,189円＋82.25 USD＋未確定分**。キャスターはAmazon.co.jp発送・既存Prime会員の送料無料条件。完成車総額ではない |
...
- [格子穴アルミ上板のJLCCNC実見積](aluminum-grid-quote/README.ja.md) / [キャスターの耐荷重・Amazon／コーナン調達](CASTER_PROCUREMENT.ja.md)
