...
**電装は再設計中です。** 回路製作設備なしの条件に合わせ、専用基板案と未加工のはんだ端子E-stopの購入案を撤回しました。完成した回路図・配線図は未作成。画像のXA1E-BV302Rは旧型番の配置参考、内部の電装形状は予約容積です。代替完成品・加工済み配線の配置検証は未実施です。[製作条件と購入表の訂正](../electrical-buildability/README.ja.md)。
...
| 費用 | 計上済み小計73,004円＋120.90 USD＝参考92,018円＋未計上分。旧電装候補6,519円を除外した分は節約ではなく、代替電装・配線は未計上 |
