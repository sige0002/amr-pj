...
p = g['parameters']
rows = [dict(g, tag='C45',grid_x=p['grid_x_mm'],grid_y=p['grid_y_mm'],grid_modeled_bore_mm=4.5,existing_frame_holes=p['frame_holes_xy_mm'],existing_stop_holes=p['stop_holes_xy_mm'],existing_slots=p['strap_slots'])]
for row in rows:
    ...
    c.drawString(35, 785, 'Revision D3 | 2026-09-22 | All dimensions in mm | Quantity 1 | Not released for fabrication or loaded use')
    ...
    c.drawString(75, 140, 'TOP VIEW | Origin at plate centre | 50mm pitch; X edge25, Y first35 / last15 (grid Y offset+10)')
    ...
    note('X=+/-109.5, Y=-39,-11; and X=+/-14, Y=+/-109.5')
    y -= 8
    note('STRAPS: 4 x obround slots 30 overall x 6 wide, R3')
    note('Centres (+/-140,10), axis Y; (60,+/-105), axis X')
    y -= 12
    ...
    note('D3: direct on3030. No support parts or spacers included.')
...
print('Wrote matching D3 PDF drawing and drawing_manifest.json')
