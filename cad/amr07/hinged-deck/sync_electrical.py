...
e.update(design='AMR01_HingedDeck_D67',date='2026-09-23',requirements_file='hinged-deck/requirements.json')
...
e['current_controls_layout']['price_scope']='Current electrical part prices above; complete current purchase quantities and costs in hinged-deck/BOM.csv.'
...
print('Shared electrical plan: D6.7 loads, rear controls, owned Pico and current prices.')
