...
M6の座面を従来のz118mmに置くため、厚い上板にφ14の座ぐりを設ける。圧縮スリーブは外径10・内径6.6・長さ4mmの候補で、金属座金→スリーブ→金属支持棒という締付力の伝達経路を作る。スリーブの購入型式、実寸、プリント穴との嵌合、座面の高さ、公差と締付力は未確定。公称形状で接触していることだけで締結成立とは扱わない。
