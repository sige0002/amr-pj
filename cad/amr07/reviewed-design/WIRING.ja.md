...
NC1/NC2は**この設計で左右を識別する名前**で、メーカー刻印の端子番号を創作したものではない。現物刻印、適合電線、端末処理、線長を確定した製作配線表は未完。M3.5ねじ端子は、メーカー指定の接続方法または端末加工済み線で使い、ユーザーのはんだ付けを前提にしない。
...
| 主電源250型端子 | 絶縁付きメス端子の加工済みリード | 現物寸法・購入型式未確定 |
