...
for row in rows:
    ...
    c.drawString(35, 785, 'Revision Q1 | 2026-09-21 | All dimensions in mm | Quantity 1 | Not released for fabrication or loaded use')
    ...
    note('Edge break <=0.2; no large chamfers on M4 threads.')
    ...
    note('X = -120, 0, 120; Y = -135, 135 (all combinations)')
    y -= 8
    ...
    note('Quote candidate only: accessory clearance / strength pending.')
...
print('Wrote 2 matching PDF drawings and drawing_manifest.json')
