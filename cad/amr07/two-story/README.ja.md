...
全車の途中小計は**75,548円＋120.90USD＋未計上分**、記録済み参考為替では約94,562円。今回のPLA材料消費参考は前版より76円増。金属ねじ・座金の購入数とパック価格はD6.4から変わらず、追加の金属加工も不要。機種別ケース・基板固定スペーサーは未選定・未計上。PLA単価2円/gは材料消費基準で、実スライス・サポート・失敗分・工賃は含まない。
