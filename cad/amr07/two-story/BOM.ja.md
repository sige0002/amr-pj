# D6.2 BOM：費用の内訳と購入リスト

**途中小計 約93,057円 ＋ 未計上分**。通常積載目標10kg、車体推計10.140kg（10kgは目安）の現行構成。
...
| モーター2個 | 14,000円 | 15.0% |
| フレーム・締結材 | 13,979円 | 15.0% |
| 専用モーター金具2個 | 12,935円 | 13.9% |
| タイヤ・キャスター | 10,413円 | 11.2% |
| 制御・電源保護 | 8,084円 | 8.7% |
| アルミ天板 | 6,078円 | 6.5% |
| PLA・ベルト・保護材 | 2,587円 | 2.8% |
| その他送料 | 1,600円 | 1.7% |
| **途中小計** | **93,057円** | **100%** |

割合の分母は計上済み小計。未計上品を0円とは扱わない。円換算は記録済みの1 USD＝157.2672円（2026-09-21参考値）で、現在の決済レートではない。元の小計は74,043円＋120.90 USD。行ごとの四捨五入で端数差が出る。
...
価格記録は既存の販売ページ確認・引継価格。自動見積はJLCCNCの実サイト記録で、未発注・担当者審査前。**モーター14,000円は仮予算**。PLA1108円は材料消費参考で、新規スプールの購入額ではない。
...
| [溝ナット HNTT6-6](https://www.amazon.co.jp/dp/B0DK9C99YH) | 78個／100個 | 5,112円 | 価格記録 |
...
| ストッパ・床継ぎ目用座金 | 12枚／未定 | 未計上 | 未計上 |
| 床継ぎ目の皿小ねじ | 4個／未定 | 未計上 | 未計上 |
...
<details><summary>PLA・ベルト・保護材 — 2,587円</summary>

| 品目 | 使用／購入 | 金額 | 根拠 |
|---|---|---:|---|
| 1階のリブ付き床4枚・継ぎ目支持梁1個・荷物ストッパ4個 | 消費554g | 1,108円 | 材料消費 |
...
**今回の床支持：各板4点、計16点。支持梁の溝ナット4個は購入予定パック内。追加M6×12ねじ4本・大径座金4枚・M4皿ねじ/座金/ナット各4個の価格は未計上。材料消費差額は費用JSONに記載。前回の支柱根元両側補強も維持。**
