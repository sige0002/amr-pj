...
前版D6.2から約122g減、車体推計10.017kg。四隅のPLAは約44.3g増え、板と締結材の削除で約166.7g減った。

PLA材料消費参考は90円増（従来基準2円/g、中実体積切上げ）。三角板素材の仮枠500円を削り、計上小計は410円減。実スライス・サポート・失敗分は含まない。ねじ・座金の一式仮枠2300円は購入パック未確定のため据置き。溝ナットは70/100個使用となり、購入パック数は変わらない。410円は現行の予算・材料消費台帳の差で、確定購入額の節約ではない。
