...
assert saved['physical_parts']==v['physical_parts']==300
...
assert len(list(HERE.glob('cad-screen-*.png')))==12
...
out=dict(revision=v['parameters']['revision'],date='2026-09-22',source_D3_revision=v['parameters']['source_revision'],files=files,
    ...
    current_print_panels=4,current_print_support_beams=1,actual_GUI_screenshots=12,
...
print('D6.2:',len(files),'hashed artifacts,',len(parts),'printed parts; current CAD/load/quote links checked.')
