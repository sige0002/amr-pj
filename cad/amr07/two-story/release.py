...
assert saved['physical_parts']==v['physical_parts']==276
...
assert len(list(HERE.glob('cad-screen-*.png')))==14
...
out=dict(revision=v['parameters']['revision'],date='2026-09-23',source_D3_revision=v['parameters']['source_revision'],files=files,
    ...
    current_print_panels=4,current_print_support_beams=1,actual_GUI_screenshots=14,
...
print('D6.4:',len(files),'hashed artifacts,',len(parts),'printed parts; current CAD/load/quote links checked.')
