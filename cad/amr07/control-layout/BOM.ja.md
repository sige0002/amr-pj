# D6.6 BOM：費用の内訳と購入リスト

**[全明細をMarkdownで読む](BOM-details.ja.md) ／ [CSVを開く・保存する](BOM.csv)**

**途中小計 約98,694円 ＋ 未計上分**。通常積載目標10kg、車体推計10.409kg（10kgは目安）の現行構成。
...
| 部位 | 金額の目安 | 割合 |
|---|---:|---:|
| 電池・充電器・アダプター | 23,380円 | 23.7% |
| フレーム・締結材 | 17,312円 | 17.5% |
| モーター2個 | 14,000円 | 14.2% |
| 専用モーター金具2個 | 12,935円 | 13.1% |
| タイヤ・キャスター | 10,413円 | 10.6% |
| 制御・電源保護 | 9,443円 | 9.6% |
| アルミ天板 | 6,078円 | 6.2% |
| PLA・ベルト・保護材 | 3,147円 | 3.2% |
| その他送料 | 1,985円 | 2.0% |
| **途中小計** | **98,694円** | **100%** |

割合の分母は計上済み小計。未計上品を0円とは扱わない。円換算は記録済みの1 USD＝157.2672円（2026-09-21参考値）で、現在の決済レートではない。元の小計は79,680円＋120.90 USD。行ごとの四捨五入で端数差が出る。
...
価格記録は既存の販売ページ確認・引継価格。自動見積はJLCCNCの実サイト記録で、未発注・担当者審査前。**モーター14,000円は仮予算**。PLA1668円は材料消費参考で、新規スプールの購入額ではない。
...
| [ブラケット・天板固定ボルト](https://www.amazon.co.jp/dp/B01N3BIIMO)<br>[D3_M6・仕様・備考](BOM-details.ja.md#item-d3_m6) | 58個／70個 | 2,360円 | 価格記録 |
| 印刷ストッパ固定ねじ<br>[D3_STOP_BOLTS・仕様・備考](BOM-details.ja.md#item-d3_stop_bolts) | 8個／未定 | 未計上 | 未計上 |
| [ストッパ・床継ぎ目用ナット](https://www.amazon.co.jp/dp/B0BVQJS1D2)<br>[D3_STOP_NUTS・仕様・備考](BOM-details.ja.md#item-d3_stop_nuts) | 20個／20個 | 273円 | 価格記録 |
| ストッパ用座金<br>[D3_STOP_WASHERS・仕様・備考](BOM-details.ja.md#item-d3_stop_washers) | 8枚／未定 | 未計上 | 未計上 |
| [床継ぎ目・操作ケース蓋のM4×16](https://store.onokatsu.co.jp/products/133-00-04)<br>[D62_FLOOR_SCREWS・仕様・備考](BOM-details.ja.md#item-d62_floor_screws) | 12個／60個 | 770円 | 価格記録 |
| 継ぎ目支持梁端の大径平座金<br>[D62_BEAM_WASHERS・仕様・備考](BOM-details.ja.md#item-d62_beam_washers) | 4個／未定 | 未計上 | 未計上 |
| [床継ぎ目・操作ケース蓋のOD12平座金](https://www.amazon.co.jp/dp/B0H8RT271F)<br>[D64_FLOOR_WASHERS・仕様・備考](BOM-details.ja.md#item-d64_floor_washers) | 16枚／20枚 | 430円 | 価格記録 |
...
| [ケース固定M6大径平座金](https://www.amazon.co.jp/dp/B0DZVCSRXG)<br>[ELEC_CASE_WASHER・仕様・備考](BOM-details.ja.md#item-elec_case_washer) | 8個／30個 | 968円 | 価格記録 |
...
| 品目 | 使用／購入 | 金額 | 根拠 |
|---|---|---:|---|
| 床・支持梁・PCカバー・荷物ストッパ・後方操作ケース<br>[P04・仕様・備考](BOM-details.ja.md#item-p04) | 消費834g | 1,668円 | 材料消費 |
