"""Capture the actual FreeCAD GUI after the A4 electrical study is generated.
...
def save(suffix):
    ...
    QtWidgets.QApplication.processEvents()
    for dock in window.findChildren(QtWidgets.QDockWidget):
        if dock.objectName() in ('Tasks','Python console','Report view'):
            dock.hide()
...
print('Saved actual FreeCAD A4 electrical-study screens: isometric/top/battery-removal/tire-service.')
