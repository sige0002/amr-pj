...
view.setCameraOrientation(App.Rotation(App.Vector(0,0,1), App.Vector(-1,-2,-.5)).Q)
save('drive-module')
for o in features:
...
Gui.updateGui()
doc.save()
print('Saved A4 actual FreeCAD screens: isometric, underside, side, top, drive-module')
