...
FILES = ["README.ja.md", "amr_d65.urdf", "amr_d65_payload_10kg.urdf", "simulation_config.json",
         ...
         "requirements-validation.txt", "render_motion_gif.py", "amr_d65_motion_mujoco.gif", "motion_gif_manifest.json"]
...
def main():
    ...
    path = HERE / "amr_d65_isaac5.zip"
    with zipfile.ZipFile(path, "w", compression=zipfile.ZIP_DEFLATED, compresslevel=9) as archive:
        for name in files + ["SHA256SUMS"]:
            info = zipfile.ZipInfo("amr_d65_isaac5/"+name, date_time=(2026, 9, 23, 0, 0, 0))
