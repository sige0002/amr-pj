...
def main():
    ...
    urdf = HERE / "amr_d61.urdf"
    output = HERE / "amr_d61_motion_mujoco.gif"
    ...
    with tempfile.TemporaryDirectory(prefix="amr-motion-frames-") as temp:
        ...
        with mujoco.Renderer(model, height=HEIGHT, width=WIDTH) as renderer:
            for step in range(round(DURATION / dt)):
                ...
                draw.text((18, 7), "AMR D6.1 走行シミュレーション / MuJoCo", font=font, fill=(242, 246, 250))
                draw.text((18, 36), f"空車 9.895 kg    格子 10 cm    実時間再生    {t:04.1f} / {DURATION} s", font=small, fill=(181, 199, 216))
