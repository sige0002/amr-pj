...
車体は**推計9.895kg**。D6.1では支柱根元4箇所を両側金具で固定しました。**通常荷物10kgの設計目標は維持**し、車体10kg＋荷物10kgで足回りを比較しています。車体重量の余裕は約105gに減り、追加機器を無条件に増やせる余裕はありません。[重量増と積載の確認](cad/amr07/two-story/PAYLOAD_REVIEW.ja.md)
