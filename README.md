...
最新は **A6：平坦な屋内床で通常積載10kg、追加の機械ブレーキなし、構造検証は荷物15kg・静的安全率2**。車体は電池・電装・荷台込み10kg以下を目標とし、現在の推計は**8.75kg**です。25kgは構造計算時の総重量で、積載量ではありません。
