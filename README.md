...
| 費用 | 計上済み小計79,523円＋120.90 USD＝参考98,537円＋未計上分。ヒンジ案より約15,663円減 |
...
費用は記録済みの2026-09-21参考為替で換算し、今回の価格再取得はしていません。PC・その電源・専用基板・配線等は未計上、モーター価格は仮予算を含みます。購入パック全額を計上した途中小計です。
